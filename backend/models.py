...
class Job(Base):
    ...
    full_location: Mapped[str | None] = mapped_column(String(255), nullable=True, index=True)
    raw_location: Mapped[str | None] = mapped_column(String(255), nullable=True)
    is_remote: Mapped[str | None] = mapped_column(String(20), nullable=True, index=True)
    work_mode: Mapped[str | None] = mapped_column(String(20), nullable=True, index=True)
    easy_apply: Mapped[str | None] = mapped_column(String(20), nullable=True, index=True)
    easy_apply_type: Mapped[str | None] = mapped_column(String(50), nullable=True)
    easy_apply_detection_source: Mapped[str | None] = mapped_column(String(50), nullable=True)
